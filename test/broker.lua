...
M.test = function()
    ...
    Broker:subscribe(eventA, function ()
        print("running callback function 1")
    end)
    Broker:subscribe(eventA, function ()
        print("running callback function 2")
    end)
    Broker:subscribe(eventB, function ()
        print("running callback function 3")
    end)
